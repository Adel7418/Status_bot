...
class TestOrderCreateSchema:
    ...
    def test_short_description(self):
        ...
        assert "at least 4" in error_str or "string_too_short" in error_str
    ...
    def test_invalid_client_name(self):
        ...
        error_str = str(exc_info.value).lower()
        assert "client_name" in error_str
        assert "at least 2" in error_str or "string_too_short" in error_str
