...
class ActiveOrdersExportService:
    ...
    async def export_active_orders_to_excel(self) -> Optional[str]:
        ...
        try:
            ...
            status_fills = {
                OrderStatus.NEW: PatternFill(start_color="FFE699", end_color="FFE699", fill_type="solid"),
                OrderStatus.ASSIGNED: PatternFill(start_color="C6E0B4", end_color="C6E0B4", fill_type="solid"),
                OrderStatus.ACCEPTED: PatternFill(start_color="A9D08E", end_color="A9D08E", fill_type="solid"),
                OrderStatus.ONSITE: PatternFill(start_color="70AD47", end_color="70AD47", fill_type="solid"),
                OrderStatus.DR: PatternFill(start_color="F4B084", end_color="F4B084", fill_type="solid"),
            }
            ...
            for status in [OrderStatus.NEW, OrderStatus.ASSIGNED, OrderStatus.ACCEPTED, OrderStatus.ONSITE, OrderStatus.DR]:
