...
async def process_notes(message: Message, state: FSMContext, user_role: str):
    ...
    await message.answer(
        ...
        "• <code>послезавтра 14:30</code>\n"
        "• <code>через 3 дня 15:00</code>\n"
        "• <code>через неделю 12:00</code>\n\n"
        "<b>⏱ Через часы:</b>\n"
        "• <code>через полтора часа</code>\n"
        "• <code>через 1-1.5 часа</code>\n"
        "• <code>через 3 часа</code>\n\n"
        "<b>📅 Точная дата:</b>\n"
        "• <code>15.10.2025 16:00</code>\n"
        "• <code>20/10/2025 09:30</code>\n\n"
        "<b>💬 Инструкции (текст):</b>\n"
        "• Набрать клиенту\n"
        "• После 14:00\n"
        "• Уточнить у клиента\n"
