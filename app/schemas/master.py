...
class MasterCreateSchema(BaseModel):
    ...
    telegram_id: int = Field(..., gt=0, description="Telegram ID мастера")
    phone: str = Field(..., min_length=10, max_length=20, description="Телефон мастера")
    specialization: str = Field(
        ..., min_length=3, max_length=200, description="Специализация мастера"
    )
    is_approved: bool = Field(default=False, description="Одобрен ли мастер администратором")
